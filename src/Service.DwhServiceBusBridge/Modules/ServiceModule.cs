...
namespace Service.DwhServiceBusBridge.Modules
{
    public class ServiceModule: Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            RegisterMessageWriter(builder, ctx => ctx.SignalBitGoTransfersTable,SignalBitGoTransfer.ServiceBusTopicName);
            ...
            RegisterMessageWriter(builder,ctx => ctx.SignalBitGoPendingApprovalTable,SignalBitGoPendingApproval.ServiceBusTopicName);
            ...
            RegisterMessageWriter(builder,ctx => ctx.SignalBitGoSessionStateUpdateTable,SignalBitGoSessionStateUpdate.ServiceBusTopicName);
            ...
            RegisterMessageWriter(builder, ctx => ctx.FeeShareTable,FeeShareEntity.TopicName);
            ...
            RegisterMessageWriter(builder,ctx=> ctx.FeePaymentTable, FeePaymentEntity.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=> ctx.ClientAuthenticationTable,ClientAuthenticationMessage.TopicName );
            ...
            RegisterMessageWriter(builder, ctx=> ctx.DepositTable,Deposit.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.WithdrawalTable,Withdrawal.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=> ctx.WithdrawalVerifiedTable, WithdrawalVerifiedMessage.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.TransferTable,Transfer.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.TransferVerificationTable,TransferVerificationMessage.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.SwapMessageTable, SwapMessage.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.ChangeBalanceHistoryTable, ChangeBalanceHistory.TopicName );
            ...
            RegisterMessageWriter(builder, ctx=>ctx.FeeShareSettlementTable, FeeShareSettlement.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.ManualSettlementTable, ManualSettlement.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.AssetPortfolioTradeTable, AssetPortfolioTrade.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.PaidInterestRateTable, PaidInterestRateMessage.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=>ctx.TradeMessageTable, TradeMessage.TopicName);
            ...
            RegisterMessageWriter(builder, ctx=> ctx.ManualChangeBalanceOperationTable,ManualChangeBalanceMessage.TopicName );
